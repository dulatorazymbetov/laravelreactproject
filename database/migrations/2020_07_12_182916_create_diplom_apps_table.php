...
class CreateDiplomAppsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('diplom_apps', function (Blueprint $table) {
            ...
            $table->string('prev_edu_doc_kk')->nullable();
            $table->string('prev_edu_doc_ru')->nullable();
            $table->string('prev_edu_doc_en')->nullable();
            $table->string('entrance_exam_kk')->nullable();
            $table->string('entrance_exam_ru')->nullable();
            $table->string('entrance_exam_en')->nullable();
            ...
            $table->integer('sac_protocol_number')->nullable();
