...
<body>
	<!--
	<div style="position:absolute; top: 0;left: 0; display: block"><img src="<?=public_path();?>/img/diploma/en1.jpg" /></div>
	-->
	<div style="position:absolute; top: 302px;left: 880px; width: 283px; text-align:center">JSC International</div>
	<div style="position:absolute; top: 354px;left: 880px; width: 283px; text-align:center">Information</div>
	<div style="position:absolute; top: 408px;left: 880px; width: 283px; text-align:center">Technology</div>
	<div style="position:absolute; top: 462px;left: 880px; width: 283px; text-align:center">University</div>
	<div style="position:absolute; top: 518px;left: 880px; width: 283px; text-align:center">Almaty</div>
	...
	<div style="position:absolute; top: 95px;left: 180px"><?=$user->last_name_en;?></div>
	<div style="position:absolute; top: 134px;left: 370px"><?=$user->first_name_en;?></div>
	<div style="position:absolute; top: 172px;left: 70px"><?=$user->middle_name_en;?></div>
	<div style="position:absolute; top: 213px;left: 220px"><?=$user->birthdate;?></div>
	<div style="position:absolute; top: 252px;left: 420px"><?=$user->prev_edu_doc_en;?></div>
	<div style="position:absolute; top: 291px;left: 70px"></div>
	<div style="position:absolute; top: 330px;left: 325px"><?=$user->entrance_exam_en;?></div>
	<div style="position:absolute; top: 370px;left: 70px"></div>
	<div style="position:absolute; top: 410px;left: 205px"><?=$user->entered_univ_name_en;?></div>
	<div style="position:absolute; top: 449px;left: 205px"><?=$user->graduated_univ_name_en;?></div>
	...
	<div style="position:absolute; top: 700px;left: 75px">
		<?php foreach($user->internships as $key => $value){ ?>
			<div style="margin-bottom: 8px">
				<div class="practic-row1"><?=$value->discipline_name_en;?></div><div class="practic-row2"><?=$value->discipline_ects_credits;?></div><div class="practic-row3"><?=$value->alpha_mark;?></div><div class="practic-row4"><?=$value->final_grade;?></div><div class="practic-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php } ?>
	</div>
	...
	<div style="position:absolute; top: 1284px;left: 296px">Diploma project</div>
	<div style="position:absolute; top: 1420px;left: 75px">
		<?php foreach($user->themes as $key => $value){ ?>
			<div style="margin-bottom: 8px">
				<div class="practic-row1"><?=$value->diploma_name_en;?></div><div class="practic-row2"><?=$value->discipline_ects_credits;?></div><div class="practic-row3"><?=$value->alpha_mark;?></div><div class="practic-row4"><?=$value->final_grade;?></div><div class="practic-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php } ?>
	</div>
	...
	<!--
	<div style="position:absolute; top: 0;left: 0; display: block"><img src="<?=public_path();?>/img/diploma/en2.jpg" /></div>
	-->
	<div style="position:absolute; top: 191px;left: 65px; font-size: 14px">
		<?php foreach($user->subjects as $key => $value){ if($key < 39){ ?>
			<div style="margin-bottom: 6px">
			<div class="subject-row1"><?=$key+1; ?></div><div class="subject-row2"><?=$value->discipline_code;?></div><div class="subject-row3"><?=$value->discipline_name_en;?></div><div class="subject-row4"><?=$value->discipline_ects_credits;?></div><div class="subject-row5"><?=$value->alpha_mark;?></div><div class="subject-row5"><?=$value->final_grade;?></div><div class="subject-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php }} ?>
	</div>
	...
	<div style="position:absolute; top: 1570px;left: 305px;"><?=$user->qualification_en; ?></div>
	<div style="position:absolute; top: 1650px;left: 75px;"><?=$user->specialty_en; ?></div>
