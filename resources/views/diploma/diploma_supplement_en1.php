...
<html>
  ...
  <div id="main_canvas">
	  ...
	  <div style="top: 64px; left: 170px; " class="norm_text1">
	  $lastname
	  </div>
	  <div style="top: 102px; left: 310px; " class="norm_text1">
	  ...
	  <p style="text-indent: 300px;vertical-align: top; margin: 0px; padding: 0px; line-height: 32px;">
	  $prev_educ</p>
	  </div>
	  <div style="top: 300px; left: 250px;" class="norm_text1">
	  $entr_exam
	  </div>
	  <div style="top: 378px; left: 120px;" class="norm_text1">
	  $enrolled
	  </div>
	  <div style="top: 418px; left: 130px;" class="norm_text1">
	  $graduated
	  </div>
	  <div style="top: 458px; left: 450px;" class="norm_text1">
	  $total_cred
	  </div>
	  ...
	  <!-- Defense 1 -->
		...
		<div class="right_block_text" style="top: 476px; ">
		$city
		</div>
		<div class="right_block_text" style="top: 676px; ">
		$diplom_number
		</div>
		<div class="right_block_text" style="top: 748px; ">
		$diplom_date
		</div>
		<div class="right_block_text" style="top: 820px; ">
		$diplom_reg_number
		</div>
