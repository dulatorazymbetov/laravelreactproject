...
<body>
	...
	<div style="position:absolute; top: 252px;left: 420px"><?=$user->prev_edu_doc_kk;?></div>
	<div style="position:absolute; top: 291px;left: 70px"></div>
	<div style="position:absolute; top: 330px;left: 325px"><?=$user->entrance_exam_kk;?></div>
	<div style="position:absolute; top: 370px;left: 70px"></div>
	<div style="position:absolute; top: 410px;left: 205px"><?=$user->entered_univ_name_kk;?></div>
	<div style="position:absolute; top: 449px;left: 205px"><?=$user->graduated_univ_name_kk;?></div>
	...
	<div style="position:absolute; top: 700px;left: 75px">
		<?php foreach($user->internships as $key => $value){ ?>
			<div style="margin-bottom: 8px">
				<div class="practic-row1"><?=$value->discipline_name_kk;?></div><div class="practic-row2"><?=$value->discipline_ects_credits;?></div><div class="practic-row3"><?=$value->alpha_mark;?></div><div class="practic-row4"><?=$value->final_grade;?></div><div class="practic-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php } ?>
	</div>
	...
	<div style="position:absolute; top: 1420px;left: 75px">
		<?php foreach($user->themes as $key => $value){ ?>
			<div style="margin-bottom: 8px">
				<div class="practic-row1"><?=$value->diploma_name_kk;?></div><div class="practic-row2"><?=$value->discipline_ects_credits;?></div><div class="practic-row3"><?=$value->alpha_mark;?></div><div class="practic-row4"><?=$value->final_grade;?></div><div class="practic-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php } ?>
	</div>
	...
	<!--
	<div style="position:absolute; top: 0;left: 0; display: block"><img src="<?=public_path();?>/img/diploma/kk2.jpg" /></div>
	-->
	<div style="position:absolute; top: 191px;left: 65px; font-size: 14px">
		<?php foreach($user->subjects as $key => $value){ if($key < 39){ ?>
			<div style="margin-bottom: 6px">
			<div class="subject-row1"><?=$key+1; ?></div><div class="subject-row2"><?=$value->discipline_code;?></div><div class="subject-row3"><?=$value->discipline_name_kk;?></div><div class="subject-row4"><?=$value->discipline_ects_credits;?></div><div class="subject-row5"><?=$value->alpha_mark;?></div><div class="subject-row5"><?=$value->final_grade;?></div><div class="subject-row5"><?=$value->traditional_mark;?></div>
			</div>
		<?php }} ?>
	</div>
